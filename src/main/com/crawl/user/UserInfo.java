...
import main.com.crawl.user.APIType;
...
public class UserInfo {
	...
	public static void main(String[] args) {
		...
		uInfo.LoadTwitterToken();
		uInfo.Consumer = uInfo.GetConsumer();
		System.out.println(uInfo.GetRateLimitStatus());
	}
	...
	public JSONObject GetRateLimitStatus() {
		try {
			...
			Logger.getLogger(UserInfo.class.getName()).log(Level.SEVERE,
					null, ex);
			...
			while (true) {
				...
				if (huc.getResponseCode() == 400
					...
					try {
						...
						Logger.getLogger(UserInfo.class.getName()).log(
